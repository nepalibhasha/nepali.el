  ...
  (transient-define-prefix nepali-varnavinyas--dispatch ()
    ...
    [["Check"
     ...
     ["Move"
      ...
      ("p" "prev" nepali-varnavinyas-previous-diagnostic :transient t)
      ("d" "detail" nepali-varnavinyas-diagnostic-at-point :transient t)]
     ["Review"
    ...
    [["Type"
     ...
     ["CLI"
      ...
      ("K" "clear" nepali-varnavinyas-clear-cache :transient t)]
     ["Setup"
      ("g" "grammar" nepali-varnavinyas-toggle-grammar :transient t)
      ("I" "auto CLI" nepali-varnavinyas-toggle-auto-install :transient t)
      ("v" "varnavinyas" nepali-varnavinyas-set-backend :transient t)
      ("h" "hunspell" nepali-hunspell-set-backend :transient t)
